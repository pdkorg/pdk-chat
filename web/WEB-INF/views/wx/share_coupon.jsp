...
<div class="top">
    <font>分享成功</font>
    <div class="back" onclick="couponClose()">
...
<div class="content">
    ...
    <div class="nr">
        ...
        <div class="quan">
            <img src="<%=resourcePath%>static/wx/images/quan.png" id="coupon_Img" onload="resetType('${requestScope.flowTypeName}')"/>
            <font class="jg">满<font>${requestScope.couponMinPayMny}</font>元使用</font>
            <font class="pr">${requestScope.couponMny}</font>
            <font class="fw" id="coupon_type">${requestScope.flowTypeName}</font>
